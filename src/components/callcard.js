...
const CallCard = ({ callDetails, isArchived }) => {
    ...
    const createdAt = new Date(callDetails.created_at);
    ...
    const formattedTime = new Intl.DateTimeFormat('en-US', { hour12: false, hour: '2-digit', minute: '2-digit' }).format(new Date(callDetails.created_at));
...
// const CallCard = ({callDetails}) => {

// const isinboundCall = callDetails.callType === 'inbound';
