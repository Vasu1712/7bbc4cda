...
const Home = () => {
	return (
		...
		<div className="w-96 h-3/5 z-100 bg-white rounded-lg shadow-lg ">
		  <Header />
		  ...
		  <Link to='/phone'>
			...
			<button className={'bg-app-green text-white mt-12 px-6 py-2 rounded-lg hover:shadow-xl hover:scale-105'}>
					Let's Get Started!
			</button>
			</div>
		  </Link>
